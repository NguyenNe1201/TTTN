        ...
        <div class="content container-fluid">
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-body">
                            <form style="display: flex;" action="" method="POST" role="form"
                                ...
                                <div style="width: 50%; margin-left:25px ">
                                    <div class="card-body">
                                        <div class="form-group">
                                            ...
                                            {{-- <select name="employceid" id="exampleInput" class="select form-control">
                                                @if (!empty($name_employce))
                                                    {
                                                    @foreach ($name_employce as $key => $item)
                                                        <option value="{{ $item->id }}">{{ $item->name }}</option>
                                                    @endforeach
                                                    }
                                                @else{
                                                    <option value="null">không có Employce</option>
                                                    }
                                                @endif
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input name="customername" value="{{ old('customername') }}" type="text"
                                ...
                                <div style="width: 50%; padding: 1rem 1rem; margin-right: 25px;">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input name="phone" value=" {{ old('phone') }}" type="text"
                                            class="form-control" placeholder="Number Phone" inputmode="numeric" required>
                                        @error('phone')
                                            <div class="alert alert-danger">{{ $message }}
                                            </div>
                                        @enderror
