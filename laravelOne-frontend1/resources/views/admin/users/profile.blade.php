                                ...
                                <div class="row">
                                    <div class="col-md-5">
                                        <div class="profile-info-left">
                                            ...
                                            <h6 class="text-muted badge bg-inverse-success">Active</h6>
                                            @else
                                            <h6 class="text-muted">Deactive</h6>
                                            @endif
                                            @if(Auth::user()->role==0)
                                            <small style="display: block;"  class="text-muted">Admin</small>
                                            @else
                                            <small class="text-muted">Employee</small>
                                            @endif
            
                                            <div class="staff-id">ID : {{ Auth::user()->id }}</div>
